...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FacebookProfile.locale'
        db.add_column('django_facebook_facebookprofile', 'locale', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True), keep_default=False)

        # Adding field 'FacebookProfile.timezone'
        db.add_column('django_facebook_facebookprofile', 'timezone', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FacebookProfile.locale'
        db.delete_column('django_facebook_facebookprofile', 'locale')

        # Deleting field 'FacebookProfile.timezone'
        db.delete_column('django_facebook_facebookprofile', 'timezone')
