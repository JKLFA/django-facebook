...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FacebookProfile.website'
        db.add_column('django_facebook_facebookprofile', 'website', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FacebookProfile.website'
        db.delete_column('django_facebook_facebookprofile', 'website')
