...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Concentration.name'
        db.alter_column('django_facebook_concentration', 'name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'Attended.type'
        db.alter_column('django_facebook_attended', 'type', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Attended.year'
        db.alter_column('django_facebook_attended', 'year', self.gf('django.db.models.fields.CharField')(max_length=8, null=True))


    def backwards(self, orm):
        
        # Changing field 'Concentration.name'
        db.alter_column('django_facebook_concentration', 'name', self.gf('django.db.models.fields.CharField')(default='Unknown', max_length=64))

        # Changing field 'Attended.type'
        db.alter_column('django_facebook_attended', 'type', self.gf('django.db.models.fields.CharField')(default='Unknown', max_length=32))

        # Changing field 'Attended.year'
        db.alter_column('django_facebook_attended', 'year', self.gf('django.db.models.fields.CharField')(default='0000', max_length=8))
    ...
    models = {
        ...
        'django_facebook.attended': {
            ...
            'year': ('django.db.models.fields.CharField', [], {'max_length': '8', 'null': 'True', 'blank': 'True'})
        },
