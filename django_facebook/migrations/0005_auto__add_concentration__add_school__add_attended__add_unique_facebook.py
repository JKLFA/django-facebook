...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('django_facebook_concentration', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=31)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal('django_facebook', ['Concentration'])

        # Adding model 'School'
        db.create_table('django_facebook_school', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=31)),
            ...
            ('founded', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
        ...
        db.send_create_signal('django_facebook', ['School'])

        # Adding model 'Attended'
        db.create_table('django_facebook_attended', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_facebook.FacebookProfile'])),
            ('school', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_facebook.School'])),
            ('year', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal('django_facebook', ['Attended'])

        # Adding M2M table for field concentrations on 'Attended'
        db.create_table('django_facebook_attended_concentrations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('attended', models.ForeignKey(orm['django_facebook.attended'], null=False)),
            ('concentration', models.ForeignKey(orm['django_facebook.concentration'], null=False))
        ))
        db.create_unique('django_facebook_attended_concentrations', ['attended_id', 'concentration_id'])

        # Adding unique constraint on 'FacebookProfile', fields ['uid']
        db.create_unique('django_facebook_facebookprofile', ['uid'])

        # Changing field 'FacebookProfile.user'
        db.alter_column('django_facebook_facebookprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['auth.User']))

        # Adding unique constraint on 'FacebookProfile', fields ['user']
        db.create_unique('django_facebook_facebookprofile', ['user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'FacebookProfile', fields ['user']
        db.delete_unique('django_facebook_facebookprofile', ['user_id'])

        # Removing unique constraint on 'FacebookProfile', fields ['uid']
        db.delete_unique('django_facebook_facebookprofile', ['uid'])

        # Deleting model 'Concentration'
        db.delete_table('django_facebook_concentration')

        # Deleting model 'School'
        db.delete_table('django_facebook_school')

        # Deleting model 'Attended'
        db.delete_table('django_facebook_attended')

        # Removing M2M table for field concentrations on 'Attended'
        db.delete_table('django_facebook_attended_concentrations')

        # Changing field 'FacebookProfile.user'
        db.alter_column('django_facebook_facebookprofile', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
