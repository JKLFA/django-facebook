...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FacebookProfile.username'
        db.add_column('django_facebook_facebookprofile', 'username', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FacebookProfile.username'
        db.delete_column('django_facebook_facebookprofile', 'username')
